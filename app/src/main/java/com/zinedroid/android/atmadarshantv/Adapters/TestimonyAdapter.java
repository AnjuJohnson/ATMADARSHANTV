...
public class TestimonyAdapter extends RecyclerView.Adapter<TestimonyAdapter.ViewHolder> {
    ...
    public TestimonyAdapter(BaseFragment context, ArrayList<Testimony> mTestimonyArrayList) {
        super();
    ...
    @Override
    public TestimonyAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_testimony_list, viewGroup, false);
        TestimonyAdapter.ViewHolder viewHolder = new TestimonyAdapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(TestimonyAdapter.ViewHolder viewHolder, int i) {
