...
public class PrayerRequestAdapter extends RecyclerView.Adapter<PrayerRequestAdapter.ViewHolder> implements WebserviceCall.WebServiceCall {
    Context context;
    int resource;
    ...
    public PrayerRequestAdapter(BaseFragment context, ArrayList<PrayerRequest> mPrayerRequestArrayList) {
        super();
    ...
    @Override
    public PrayerRequestAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_prayer_request, viewGroup, false);
        PrayerRequestAdapter.ViewHolder viewHolder = new PrayerRequestAdapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(PrayerRequestAdapter.ViewHolder viewHolder, final int i) {
  ...
  //      viewHolder.username.setText("by "+mPrayerRequest.getRequuest_user_name()+","+mPrayerRequest.getPlace());
        ...
        viewHolder.pray.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              mAddPrayCount.addpraycount(i,mPrayerRequest.getReq_count());
                ...
                new WebserviceCall(PrayerRequestAdapter.this, baseFragment, AppConstants.Methods.addprayecount).execute(baseFragment.getSharedPreference(AppConstants.SharedKey.USER_ID), baseFragment.getSharedPreference(AppConstants.SharedKey.DEVICE_ID),mPrayerRequest.getId());
            }
        });
    ...
    public int getItemCount() {
        if(mPrayerRequestArrayList.size()>3){
            return 4;
        }
        else {
