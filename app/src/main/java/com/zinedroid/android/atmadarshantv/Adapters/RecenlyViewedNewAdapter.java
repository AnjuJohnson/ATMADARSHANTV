 ...
 */
public class RecenlyViewedNewAdapter  extends RecyclerView.Adapter<RecenlyViewedNewAdapter.ViewHolder> {

        ArrayList<Video> mVideoArrayList;
        ArrayList<String> alImage;
        Context context;

public RecenlyViewedNewAdapter(Context context, ArrayList<Video> mVideoArrayList) {
        super();
...
public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        .inflate(R.layout.item_recentlyviewed, viewGroup, false);
