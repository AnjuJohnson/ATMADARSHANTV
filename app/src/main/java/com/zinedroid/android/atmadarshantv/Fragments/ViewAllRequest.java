...
public class ViewAllRequest   extends BaseFragment implements WebserviceCall.WebServiceCall,ViewAllRequestAdapter.addPrayCount {
    Context context;
    ...
    videoArrayList = (ArrayList<PrayerRequest>)getArguments().getSerializable("prayer_request");
        ...
        mAdapter = new ViewAllRequestAdapter(ViewAllRequest.this, videoArrayList);
    ...
    public void onResume() {
        super.onResume();
        mOnFragmnetSwitch.loadTitle("Prayer Requests");
        OnMenuIconChange.iconchange(ViewAllRequest.this);
        HomeActivity.fragment = ViewAllRequest.this;
    }
    ...
    public void addpraycount(int i, String count) {
        ...
        videoArrayList.get(i).setReq_count(String.valueOf(added_praycount));
