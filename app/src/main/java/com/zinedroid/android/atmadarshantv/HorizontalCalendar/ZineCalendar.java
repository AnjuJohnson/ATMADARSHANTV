 ...
 */
public class ZineCalendar {

    //region private Fields
    private ZineCalendarView calendarView;
    private ZineCalendarAdapter mCalendarAdapter;
    ...
    //Interface events
    private ZineCalendarListener calendarListener;
     ...
     */
    private ZineCalendar(Builder builder) {
    ...
    private void loadZineCalendar() {
        ...
        calendarView.setZineCalendar(this);
    ...
    public ZineCalendarListener getCalendarListener() {
        return calendarListener;
    }

    public void setCalendarListener(ZineCalendarListener calendarListener) {
    ...
    public void selectDate(Date date, boolean immediate) {
        if (loading) {
            ...
            if (immediate) {
                ...
                calendarView.setSmoothScrollSpeed(ZineLayoutManager.SPEED_NORMAL);
    ...
    public static class Builder {
        ...
        /**
         * @return Instance of {@link ZineCalendar} initiated with builder settings
         */
        public ZineCalendar build() {
            initDefaultValues();
            ZineCalendar horizontalCalendar = new ZineCalendar(this);
            horizontalCalendar.loadZineCalendar();
    ...
    private class InitializeDatesList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            mCalendarAdapter = new ZineCalendarAdapter(calendarView, mListDays);
            calendarView.setAdapter(mCalendarAdapter);
            calendarView.setLayoutManager(new ZineLayoutManager(calendarView.getContext(), false));
    ...
    private static class DateHandler extends Handler {
        ...
        private final WeakReference<ZineCalendar> horizontalCalendar;
        public Date date = null;
        public boolean immediate = true;

        public DateHandler(ZineCalendar horizontalCalendar, Date defaultDate) {
        ...
        public void handleMessage(Message msg) {
            ZineCalendar calendar = horizontalCalendar.get();
            if (calendar != null) {
